    ...
    buildSlides() {
      return [
        ...
        },
        {
          ...
          content: '<h2><span class="pres-tag accent">Architecture</span> System Component Overview</h2><div style="display:flex;justify-content:center;margin:12px 0"><svg viewBox="0 0 900 420" style="width:100%;max-width:900px" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="ga1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#00d4ff" stop-opacity="0.2"/><stop offset="100%" stop-color="#7c5cf7" stop-opacity="0.1"/></linearGradient><linearGradient id="ga2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#ff6b35" stop-opacity="0.15"/><stop offset="100%" stop-color="#f85149" stop-opacity="0.08"/></linearGradient><marker id="arrowW" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="none" stroke="#5a6578" stroke-width="1"/></marker></defs><rect x="0" y="0" width="900" height="420" fill="none"/><rect x="20" y="10" width="860" height="50" rx="8" fill="url(#ga1)" stroke="#00d4ff" stroke-opacity="0.3"/><text x="450" y="42" text-anchor="middle" fill="#00d4ff" font-size="14" font-weight="700" font-family="monospace">AETHERIX PLATFORM</text><rect x="20" y="75" width="200" height="140" rx="8" fill="rgba(0,212,255,0.06)" stroke="#00d4ff" stroke-opacity="0.25"/><text x="120" y="100" text-anchor="middle" fill="#00d4ff" font-size="11" font-weight="700" font-family="monospace">INFRASTRUCTURE</text><text x="120" y="120" text-anchor="middle" fill="#8892a4" font-size="9.5">link_budget.py</text><text x="120" y="136" text-anchor="middle" fill="#8892a4" font-size="9.5">rf_link_budget.py</text><text x="120" y="156" text-anchor="middle" fill="#5a6578" font-size="8.5">FSPL, EIRP, margin</text><text x="120" y="172" text-anchor="middle" fill="#5a6578" font-size="8.5">Ka/X/S/UHF bands</text><text x="120" y="192" text-anchor="middle" fill="#5a6578" font-size="8.5">CCSDS 141.0-B-1</text><rect x="240" y="75" width="200" height="140" rx="8" fill="rgba(124,92,247,0.06)" stroke="#7c5cf7" stroke-opacity="0.25"/><text x="340" y="100" text-anchor="middle" fill="#7c5cf7" font-size="11" font-weight="700" font-family="monospace">ROUTING</text><text x="340" y="120" text-anchor="middle" fill="#8892a4" font-size="9.5">rl_agent.py</text><text x="340" y="136" text-anchor="middle" fill="#8892a4" font-size="9.5">bundle.py / ltp.py</text><text x="340" y="156" text-anchor="middle" fill="#5a6578" font-size="8.5">Q-learning, epsilon-greedy</text><text x="340" y="172" text-anchor="middle" fill="#5a6578" font-size="8.5">BPv7, LTP, TCPCL, UDP-CL</text><text x="340" y="192" text-anchor="middle" fill="#5a6578" font-size="8.5">RFC 9171, RFC 5326</text><rect x="460" y="75" width="200" height="140" rx="8" fill="rgba(200,76,255,0.06)" stroke="#c84cff" stroke-opacity="0.25"/><text x="560" y="100" text-anchor="middle" fill="#c84cff" font-size="11" font-weight="700" font-family="monospace">SECURITY</text><text x="560" y="120" text-anchor="middle" fill="#8892a4" font-size="9.5">qkd.py</text><text x="560" y="136" text-anchor="middle" fill="#8892a4" font-size="9.5">repeater_chain.py</text><text x="560" y="156" text-anchor="middle" fill="#5a6578" font-size="8.5">BB84, E91 protocols</text><text x="560" y="172" text-anchor="middle" fill="#5a6578" font-size="8.5">CASCADE reconciliation</text><text x="560" y="192" text-anchor="middle" fill="#5a6578" font-size="8.5">NIST FIPS 203/204 (PQC)</text><rect x="680" y="75" width="200" height="140" rx="8" fill="rgba(255,107,53,0.06)" stroke="#ff6b35" stroke-opacity="0.25"/><text x="780" y="100" text-anchor="middle" fill="#ff6b35" font-size="11" font-weight="700" font-family="monospace">ORBITAL</text><text x="780" y="120" text-anchor="middle" fill="#8892a4" font-size="9.5">contact_windows.py</text><text x="780" y="136" text-anchor="middle" fill="#8892a4" font-size="9.5">topology.py / doppler.py</text><text x="780" y="156" text-anchor="middle" fill="#5a6578" font-size="8.5">5-tier, 241 nodes</text><text x="780" y="172" text-anchor="middle" fill="#5a6578" font-size="8.5">Synodic period modeling</text><text x="780" y="192" text-anchor="middle" fill="#5a6578" font-size="8.5">Doppler compensation</text><line x1="120" y1="215" x2="120" y2="240" stroke="#5a6578" stroke-width="1" marker-end="url(#arrowW)"/><line x1="340" y1="215" x2="340" y2="240" stroke="#5a6578" stroke-width="1" marker-end="url(#arrowW)"/><line x1="560" y1="215" x2="560" y2="240" stroke="#5a6578" stroke-width="1" marker-end="url(#arrowW)"/><line x1="780" y1="215" x2="780" y2="240" stroke="#5a6578" stroke-width="1" marker-end="url(#arrowW)"/><rect x="20" y="245" width="860" height="55" rx="8" fill="url(#ga2)" stroke="#ff6b35" stroke-opacity="0.25"/><text x="450" y="268" text-anchor="middle" fill="#ff6b35" font-size="11" font-weight="700" font-family="monospace">SIMULATION ENGINE</text><text x="450" y="286" text-anchor="middle" fill="#8892a4" font-size="9.5">simulator.py &middot; policy_engine.py &middot; training.py &middot; multi_agent.py &middot; forwarding_engine.py</text><line x1="450" y1="300" x2="450" y2="320" stroke="#5a6578" stroke-width="1" marker-end="url(#arrowW)"/><rect x="130" y="325" width="640" height="50" rx="8" fill="rgba(63,185,80,0.06)" stroke="#3fb950" stroke-opacity="0.25"/><text x="450" y="348" text-anchor="middle" fill="#3fb950" font-size="11" font-weight="700" font-family="monospace">WEB SHOWCASE &mdash; 10 Interactive Demos</text><text x="450" y="365" text-anchor="middle" fill="#8892a4" font-size="9.5">matx104.github.io/AETHERIX &middot; 149 tests &middot; 27 Python modules</text><rect x="20" y="390" width="410" height="24" rx="4" fill="rgba(0,212,255,0.04)" stroke="#00d4ff" stroke-opacity="0.15"/><text x="225" y="406" text-anchor="middle" fill="#5a6578" font-size="8">CCSDS 734.2-B-1 &middot; CCSDS 735.1-B-1 &middot; CCSDS 141.0-B-1 &middot; CCSDS 142.0-B-2</text><rect x="470" y="390" width="410" height="24" rx="4" fill="rgba(124,92,247,0.04)" stroke="#7c5cf7" stroke-opacity="0.15"/><text x="675" y="406" text-anchor="middle" fill="#5a6578" font-size="8">RFC 9171 &middot; RFC 5326 &middot; RFC 7242 &middot; NIST FIPS 203/204</text></svg></div>',
        ...
        },
        {
          ...
          speakerNotes: 'Walk through the diagram. Top: TCP fails because it needs end-to-end ACK. Bottom: DTN store-and-forward works. Each node takes custody. If link drops, bundle stays safe in storage. Three convergence layers for different link types. (1.5 minutes)'
        },
        {
        ...
        },
        {
          ...
          speakerNotes: 'This is the full network. Earth segment on the left, Mars on the right, deep space relay in the middle. Walk through the 5 tiers. Emphasize redundancy: three paths from Earth to Mars. Lagrange relays are the key innovation for conjunction coverage. (1.5 minutes)'
        },
        {
        ...
        },
        {
          ...
          speakerNotes: 'Walk through the 7 hops. Start at Mars surface with the rover. UHF to areostationary, optical ISL to polar orbiter, then the big jump across 225M km of deep space. LEO mesh for Earth-side routing, DSN for downlink, fiber to JPL. Total: ~13 min. (1.5 minutes)'
        },
        {
          title: 'RL Routing',
        ...
        },
        {
          ...
          speakerNotes: 'Walk through the full data flow. Application creates data, BPv7 wraps it, RL routes it, QKD encrypts it. Then LTP segments for transport, store-and-forward at the convergence layer, physical transmission. At destination: reassemble, decrypt, deliver. (1.5 minutes)'
        },
        {
          title: 'Performance',
