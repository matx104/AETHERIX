  ...
  const study = {
    ...
    renderDashboardStats() {
      ...
      const stats = [
        ...
        { value: '189', label: 'Unit Tests', color: '#00d4aa', sub: '10 test modules' },
  ...
  const presentation = {
    ...
    _injectScripts(slides) {
      var scripts = {
        ...
        'Architecture Diagram': "This diagram shows how the source modules feed into the simulation engine and web demos. Each module is independently testable — we have 189 automated tests validating correctness.",
        ...
        'Implementation': "This is real, working code. 27 Python modules, 189 tests, 12 interactive demos. All the physics is real — no mocked data. The showcase site has live calculators you can use right now. Standards compliance is complete — seven CCSDS Blue Books and four IETF RFCs.",
