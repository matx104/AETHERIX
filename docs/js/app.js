  ...
  const presentation = {
    ...
    buildSlides() {
      return [
        ...
        },
        {
          title: 'Performance',
          compact: true,
          content: '<h2><span class="pres-tag success">Results</span> What We Achieved &mdash; Simulated vs Design Target</h2><div class="pres-grid-2" style="margin-bottom:16px"><div class="pres-card pres-card-accent"><div class="pres-card-title">&#10003; Simulated &amp; Verified <span style="font-weight:400;font-size:0.75rem">(run_simulation.py, seed=42)</span></div><table class="pres-table"><thead><tr><th style="text-align:left">Metric</th><th style="text-align:left">Result</th></tr></thead><tbody><tr><td><strong>Topology</strong></td><td>241 nodes, 5 tiers</td></tr><tr><td><strong>Routing</strong></td><td>RL Q-learning, autonomous</td></tr><tr><td><strong>Training</strong></td><td>Converges ~140 episodes</td></tr><tr><td><strong>Conjunction</strong></td><td>Auto-reroute via Lagrange relay</td></tr><tr><td><strong>Security</strong></td><td>BB84 QKER &lt; 11% threshold</td></tr><tr><td><strong>Radiation</strong></td><td>200&times; error reduction (TMR+ECC)</td></tr></tbody></table></div><div class="pres-card"><div class="pres-card-title">&diams; Design Targets <span style="font-weight:400;font-size:0.75rem">(model-based goals)</span></div><table class="pres-table"><thead><tr><th style="text-align:left">Metric</th><th style="text-align:left">Current &rarr; Target</th></tr></thead><tbody><tr><td><strong>Data Rate</strong></td><td>0.5&ndash;6 Mbps &rarr; 2&ndash;200 Mbps</td></tr><tr><td><strong>Availability</strong></td><td>60&ndash;75% &rarr; &gt;95%</td></tr><tr><td><strong>Daily Volume</strong></td><td>5&ndash;10 GB &rarr; 50&ndash;100 GB</td></tr><tr><td><strong>Cost per MB</strong></td><td>$0.10 &rarr; $0.01</td></tr><tr><td><strong>Scalability</strong></td><td>5&ndash;10 assets &rarr; 241 nodes</td></tr><tr><td><strong>Conjunction</strong></td><td>Blackout &rarr; Lagrange fallback</td></tr></tbody></table></div></div><div class="pres-grid-4"><div class="pres-stat-card" style="border-color:rgba(63,185,80,0.2)"><div class="pres-stat-value" style="color:#3fb950">241</div><div class="pres-stat-unit">Network nodes &#10003;</div></div><div class="pres-stat-card" style="border-color:rgba(0,212,255,0.2)"><div class="pres-stat-value" style="color:#00d4ff">200&times;</div><div class="pres-stat-unit">Radiation error reduction &#10003;</div></div><div class="pres-stat-card" style="border-color:rgba(124,92,247,0.2)"><div class="pres-stat-value" style="color:#7c5cf7">480</div><div class="pres-stat-unit">Unit tests passing &#10003;</div></div><div class="pres-stat-card" style="border-color:rgba(255,107,53,0.2)"><div class="pres-stat-value" style="color:#ff6b35">10&ndash;100&times;</div><div class="pres-stat-unit">Target speedup &diams;</div></div></div><div class="pres-callout pres-callout-accent" style="margin-top:16px">&#10003; = backed by simulation (seed=42) &middot; &diams; = model-based design target &middot; Run live: <code>python run_simulation.py</code></div>',
          speakerNotes: 'Be honest about what is simulated versus what is a target. Left column: everything verified by run_simulation.py with seed 42. 241-node topology works. RL routing converges in about 140 episodes. Solar conjunction reroutes through Lagrange relays automatically. BB84 detects eavesdroppers. Radiation stack reduces errors 200-fold. Right column: model-based targets. The 2 to 200 Mbps data rate comes from our inverse-square link model, but the link budget does not yet close at those rates. Over 95 percent availability and the cost figures are design goals, not measured. (1.5 minutes)'
        },
        {
          ...
          content: this._chartSlide('AETHERIX vs Current Systems', 'Results', '#3fb950', 'img/charts/performance_comparison.png',
            'Model-based targets vs current MRO baseline',
            ...
            'Head-to-head comparison: simulated achievements (left) and model-based design targets (right).',
            'Verified: 241-node topology, RL routing, QKD security, 200&times; radiation protection. Targets: 10&ndash;100&times; data rate, &gt;95% availability.'),
          speakerNotes: 'Head-to-head comparison showing AETHERIX achievements and targets. Be clear: the left side is simulated, the right side is model-based goals. (20 seconds)'
        },
        {
    ...
    _injectScripts(slides) {
      var scripts = {
        ...
        'Performance': "Be honest. Left column is simulated and verified: 241-node topology, RL routing that converges in 140 episodes, autonomous conjunction reroute via Lagrange relays, BB84 eavesdropper detection, and 200-times radiation error reduction. Right column is design targets: the 2 to 200 Mbps data rate comes from our inverse-square link model, over 95 percent availability and the cost figures are goals not yet measured. The link budget shows negative margins at current parameters, so closing the link is future work.",
