...
window.App = (() => {
  ...
  const presentation = {
    ...
    mermaidDiagrams: {
      'system-architecture': 'graph TB\\n    subgraph SRC[\"Python Source - 27 Modules\"]\\n        INFRA[\"Infrastructure<br/>link_budget.py, rf_link_budget.py<br/>FSPL, EIRP, Margin, CCSDS 141.0-B-1\"]\\n        ROUTE[\"Routing<br/>rl_agent.py, bundle.py, ltp.py<br/>BPv7, LTP, TCPCL, UDP-CL, RFC 9171\"]\\n        SEC[\"Security<br/>qkd.py, repeater_chain.py<br/>BB84, E91, CASCADE, NIST FIPS 203/204\"]\\n        ORBIT[\"Orbital<br/>contact_windows.py, topology.py<br/>5-Tier, 241 Nodes, Doppler\"]\\n    end\\n    subgraph ENGINE[\"Simulation Engine\"]\\n        SIM[simulator.py]\\n        POLICY[policy_engine.py]\\n        TRAIN[\"training.py, multi_agent.py\"]\\n        FWD[forwarding_engine.py]\\n    end\\n    subgraph WEB[\"Web Showcase - 10 Demos\"]\\n        DASH[Mission Control]\\n        LB[Link Budget]\\n        RL[RL Routing]\\n        QKD[QKD Protocol]\\n        ORB[Orbital Mechanics]\\n        DTN[DTN Engine]\\n        MISS[Mars Mission]\\n    end\\n    INFRA --> SIM\\n    ROUTE --> SIM\\n    SEC --> SIM\\n    ORBIT --> SIM\\n    SIM --> POLICY\\n    SIM --> TRAIN\\n    SIM --> FWD\\n    POLICY --> DASH\\n    FWD --> DTN\\n    ROUTE --> RL\\n    SEC --> QKD\\n    ORBIT --> ORB\\n    INFRA --> LB\\n    SIM --> MISS',
      'network-topology': 'graph LR\\n    subgraph EARTH[\"EARTH\"]\\n        T1[\"T1: Earth Ground<br/>6 Nodes<br/>Goldstone, Madrid, Canberra\"]\\n        T2[\"T2: Earth Orbital<br/>51 Nodes<br/>3 GEO + 48 LEO Laser Mesh\"]\\n    end\\n    subgraph DEEP[\"DEEP SPACE\"]\\n        T3[\"T3: Transit<br/>4 Nodes<br/>ES-L4, ES-L5 Lagrange Relays\"]\\n    end\\n    subgraph MARS[\"MARS\"]\\n        T4[\"T4: Mars Orbital<br/>13 Nodes<br/>2 Areostationary + 9 Relay\"]\\n        T5[\"T5: Mars Surface<br/>167 Nodes<br/>Habitats, Rovers, Drones\"]\\n    end\\n    T1 -->|\"1550nm Optical 100 Mbps\"| T2\\n    T2 -->|\"10 Gbps ISL\"| T3\\n    T3 -->|\"Deep Space 2-200 Mbps\"| T4\\n    T4 -->|\"UHF 2 Mbps\"| T5\\n    T2 -.->|\"Redundant via ES-L5\"| T3\\n    T3 -.->|\"Direct optical\"| T4',
      'data-flow': 'graph TD\\n    subgraph APP[\"Application Layer\"]\\n        SRC[\"1. Source Node<br/>Science data 500 MB\"]\\n        BP[\"2. Bundle Protocol<br/>BPv7 wraps + metadata\"]\\n        RL[\"3. RL Routing<br/>Agent selects next hop\"]\\n        QE[\"4. QKD Encrypt<br/>BB84 key, AES-256\"]\\n    end\\n    subgraph CONV[\"Convergence Layer\"]\\n        LTP[\"5. LTP Segmentation<br/>RS encoding, retransmit\"]\\n        STORE[\"6. Store and Wait<br/>Buffer until link up\"]\\n        FWD[\"7. Forward + Custody\"]\\n    end\\n    subgraph PHYS[\"Physical Layer\"]\\n        UHF[Mars UHF 2 Mbps]\\n        ISL[Optical ISL 10 Gbps]\\n        DEEP[Deep Space 1550nm]\\n        KAB[DSN Ka-band]\\n    end\\n    subgraph DELIV[\"Delivery\"]\\n        RASM[8. LTP Reassemble]\\n        DEC[9. QKD Decrypt]\\n        DEL[\"10. Delivered - JPL MOC\"]\\n    end\\n    SRC --> BP --> RL --> QE\\n    QE --> LTP --> STORE --> FWD\\n    FWD --> UHF\\n    FWD --> ISL\\n    FWD --> DEEP\\n    FWD --> KAB\\n    UHF --> RASM\\n    ISL --> RASM\\n    DEEP --> RASM\\n    KAB --> RASM\\n    RASM --> DEC --> DEL'
    },
